...
public class DebtsJpaController implements Serializable {
    ...
    public void edit(Debts debts) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            ...
            for (Paymenthistory paymenthistoryListOldPaymenthistory : paymenthistoryListOld) {
                if (!paymenthistoryListNew.contains(paymenthistoryListOldPaymenthistory)) {
                    paymenthistoryListOldPaymenthistory.setDebtsDebtId(null);
                    paymenthistoryListOldPaymenthistory = em.merge(paymenthistoryListOldPaymenthistory);
                }
            }
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            List<Paymenthistory> paymenthistoryList = debts.getPaymenthistoryList();
            for (Paymenthistory paymenthistoryListPaymenthistory : paymenthistoryList) {
                paymenthistoryListPaymenthistory.setDebtsDebtId(null);
                paymenthistoryListPaymenthistory = em.merge(paymenthistoryListPaymenthistory);
            }
            em.remove(debts);
            em.getTransaction().commit();
